...
BOOL CPrtStationApp::InitInstance()
{
	...
	{		
		MessageBox(NULL, _T("客户端正在运行中,不能重复打开！"), _T("社会保障卡冠苑制卡工作站"), MB_OK);
		//AfxMessageBox(_T("客户端正在运行中,不能重复打开"), MB_OK | MB_APPLMODAL | MB_ICONSTOP);
		return (FALSE);
	}
